...
exports.bidProduct = function (req,res){
	...
	var myResult = "Select A.ITEM_CODE,A.ITEM_NAME, A.category, A.ITEM_DESC,A.COND,A.MIN_PRICE,A.SELLER_USERNAME,B.PRICE_BID from PRODUCT A, BID B where A.ITEM_CODE = B.ITEM_CODE AND A.ITEM_CODE ='" + id +"';" ;
