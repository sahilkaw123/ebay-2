	...
	mysql.fetchData(function(err,results){
		...
		else 
		{
			if(results.length > 0){
				...
				var addUser = "INSERT INTO cart (ITEM_CODE, ITEM_NAME, ITEM_DESC, QUANTITY, SELLER_USERNAME, BUYER_USERNAME, TOTAL_PRICE ,PRICE, bid) VALUES" +
			    "('" + id + "','"+ name +"','" + desc +"','" + Qty +"','" + S_Usrname +"','" + B_Usrname +"','"+ T_Price +"','" + Price +"','" + Bid +"');";
